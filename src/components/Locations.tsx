...
export default function Locations() {
  return (
    <div className="w-full flex flex-col lg:flex-row lg:justify-between xl:px-20 items-center gap-y-16 my-16 md:my-28">
      {locations.map((location) => (
        <div className="flex flex-col items-center gap-y-5" key={location.name}>
